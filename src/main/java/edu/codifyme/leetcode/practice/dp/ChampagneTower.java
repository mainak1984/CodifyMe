...
/**
 * 799. Champagne Tower
 * MEDIUM: https://leetcode.com/problems/champagne-tower/
 *
 ...
 * the top glass is 10; the total flow-through of each glass in the second row is 4.5, and so on.
 *
 * Algorithm:
 * In general, if a glass has flow-through X, then Q = (X - 1.0) / 2.0 quantity of champagne will equally flow left and
 * right. We can simulate the entire pour for 100 rows of glasses. A glass at (r, c) will have excess champagne flow
