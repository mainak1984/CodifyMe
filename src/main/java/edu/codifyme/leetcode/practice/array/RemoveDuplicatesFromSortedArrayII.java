 ...
 * Explanation: Your function should return length = 7, with the first seven elements of nums being modified to
 * 0, 0, 1, 1, 2, 3 and 3 respectively. It doesn't matter what values are set beyond the returned length.
 *
 * Constraints:
 * 0 <= nums.length <= 3 * 104
 * -104 <= nums[i] <= 104
...
public class RemoveDuplicatesFromSortedArrayII {
    ...
    public int removeDuplicates1(int[] nums) {
        ...
        // Do some processing for end nodes
