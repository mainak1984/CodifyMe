 ...
 * his direct subordinates and they will inform their subordinates and so on until all employees know about urgent news.
...
public class TimeNeededToInformEmployees {
    ...
    public int dfs(int n, int [] manager, int [] informTime){
        if (manager[n] != -1){
...
//
//        buildGraph(manager);
//        recur(headID, informTime, 0);
//
//        return max;
//    }
//
//    void recur(int index, int[] infoTime, int prevInfoTime) {
//        if (!graph.containsKey(index)) {
//            max = max < prevInfoTime? prevInfoTime: max;
//            return;
//        }
//
//        for (Integer child: graph.get(index)) {
//            recur(child, infoTime, prevInfoTime + infoTime[index]);
//        }
//    }
//
//    void buildGraph(int[] manager) {
//        for (int i = 0; i < manager.length; i++) {
//            graph.putIfAbsent(manager[i], new HashSet<Integer>());
