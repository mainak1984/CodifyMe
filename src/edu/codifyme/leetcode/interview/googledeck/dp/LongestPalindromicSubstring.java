package edu.codifyme.leetcode.interview.googledeck.dp;
 ...
 * there are only 2n - 12n−1 such centers.
 * You might be asking why there are 2n - 12n−1 but not nn centers? The reason is the center of a palindrome can be in
 * between two letters. Such palindromes have even number of letters (such as "abba") and its center are between the
 * two 'b's.
 */
